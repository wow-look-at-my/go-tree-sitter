...
//go:generate go run github.com/wow-look-at-my/go-tree-sitter/cmd/ts-translate -package rust -repo tree-sitter/tree-sitter-rust -rev 77a3747266f4d621d0757825e6b11edcbf991ca5 -out parser.go testdata/tree-sitter-rust/src/parser.c
