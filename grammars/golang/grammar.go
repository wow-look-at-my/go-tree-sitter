...
//go:generate go run github.com/wow-look-at-my/go-tree-sitter/cmd/ts-translate -package golang -repo tree-sitter/tree-sitter-go -rev 2346a3ab1bb3857b48b29d779a1ef9799a248cd7 -out parser.go testdata/tree-sitter-go/src/parser.c
