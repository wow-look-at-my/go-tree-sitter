...
//go:generate go run github.com/wow-look-at-my/go-tree-sitter/cmd/ts-translate -package javascript -repo tree-sitter/tree-sitter-javascript -rev 58404d8cf191d69f2674a8fd507bd5776f46cb11 -out parser.go testdata/tree-sitter-javascript/src/parser.c
