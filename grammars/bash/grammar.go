...
//go:generate go run github.com/wow-look-at-my/go-tree-sitter/cmd/ts-translate -package bash -repo tree-sitter/tree-sitter-bash -rev a06c2e4415e9bc0346c6b86d401879ffb44058f7 -out parser.go testdata/tree-sitter-bash/src/parser.c
